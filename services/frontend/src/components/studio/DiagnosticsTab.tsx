          ...
          <div className="shot-timeline">
            {diagnosticShots.map((shot) => (
              <div className="shot-row" key={shot.id}>
                {(() => {
                  const contract = getProviderEndpointContract(shot);
                        ...
                        <div className="provider-meta-card">
                          {contract ? (
                            <details className="payload-block">
                              <summary>
                                <span className="metric-label">Endpoint Contract</span>
                              </summary>
                              <div className="detail-list">
                                <div className="detail-row">
                                ...
                                <div className="detail-row">
                                  ...
                                  <span className="mono-text task-id-text">
                                    {contract.method} {contract.url}
                                  </span>
                                </div>
                                {contract.notes ? (
                                  <div className="detail-row">
                                ...
                                <div className="detail-row">
                                  ...
                                  <span>
                                    {contract.fields.map((field) => `${field.name}${field.required ? "*" : ""}: ${field.type}`).join(" · ")}
                                  </span>
                                </div>
                              </div>
                            </details>
